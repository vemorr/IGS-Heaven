...
IGS.S.COLORS = {
	FRAME_HEADER        = Color(21,13,42*0.75), -- Фон верхушки фреймов в т.ч. пополнения счета и т.д. https://img.qweqwe.ovh/1491950958825.png
	ACTIVITY_BG         = Color(21,13,42*0.75), -- Фон в каждой вкладке (основной) https://img.qweqwe.ovh/1509370647204.png
	TAB_BAR             = Color(21,13,42*0.75), -- Фон таб бара https://img.qweqwe.ovh/1509370669492.png

	PASSIVE_SELECTIONS  = Color(136,95,255), -- Фон панели тегов, цвет кнопки с балансом, верхушки таблиц, не выделенные кнопки https://img.qweqwe.ovh/1509370720597.png
	INNER_SELECTIONS    = Color(136,95,255), -- Фон иконок на плашках, фон панелек последних покупок... https://img.qweqwe.ovh/1509370766148.png
	...
	TEXT_HARD           = Color(136,95,255),       -- Заголовки, выделяющиеся тексты https://img.qweqwe.ovh/1509372019687.png
	TEXT_SOFT           = Color(136,95,255), -- Описания, значения чего-то
	TEXT_ON_HIGHLIGHT   = Color(136,95,255), -- Цвет текста на выделенных кнопках
	...
	ICON                = Color(136,95,255), -- цвет иконок на плашечках
}
